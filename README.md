...
2. Open `BluetoothCar.ino` in Arduino IDE.
3. Upload the sketch to the Arduino board.
4. Pair your Bluetooth module with a smartphone app (e.g., Arduino Bluetooth Controller).
5. Use the app buttons to control the car:
   - Forward
   - Backward
   - Left
   - Right
